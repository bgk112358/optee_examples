...
- [编译] 设置 ql-ol-crosstool-env-init 的前提下，会报错 from Crypto.Signature import PKCS1_v1_5； ImportError: No module named 'Crypto'；是因为交叉环境里的 python3 没有 Crypto 模块，可以通过一些方法解决模块依赖问题，本地按照好模块后，兼容版本前提下，拷贝 'Crypto' 模块到交叉工具链里
```bash
